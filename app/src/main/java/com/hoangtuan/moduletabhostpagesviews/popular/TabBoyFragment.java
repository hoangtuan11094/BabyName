 ...
 * {@link TabBoyFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link TabBoyFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TabBoyFragment extends Fragment {
     ...
     * @return A new instance of fragment TabBoyFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static TabBoyFragment newInstance(String param1) {
        TabBoyFragment fragment = new TabBoyFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tab_boy, container, false);
        initBoy(view);
        return view;
    }

    private void initBoy(View view) {
        recyBoy = (RecyclerView) view.findViewById(R.id.recyBoy);
        recyBoy.setHasFixedSize(true);
        LinearLayoutManager manager = new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false);
        recyBoy.setLayoutManager(manager);
        recyBoy.addItemDecoration(new DividerItemDecoration(getActivity(), DividerItemDecoration.VERTICAL));
        ...
        Cursor cursor = database.rawQuery("select ZRANKING,ZBABYNAME,ZGENDERTYPE,ZORIGINS,ZPOPULARBABYNAME FROM ZBABYNAME INNER JOIN ZBABYPOPULARITY ON ZBABYNAME.Z_PK=ZBABYPOPULARITY.ZPOPULARBABYNAME WHERE ZBABYPOPULARITY.ZRANKING<=100 AND ZBABYPOPULARITY.ZYEAR="+mParam1+" AND ZBABYPOPULARITY.ZGENDER=1 ORDER BY ZRANKING ASC", null);
        ...
        recyBoy.setAdapter(mainAdapter);


        //TODO: Set Click Recycleview
        recyBoy.addOnItemTouchListener(new RecyclerItemClickListener(getActivity(), recyBoy, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
